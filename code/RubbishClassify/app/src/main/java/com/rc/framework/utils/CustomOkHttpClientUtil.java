...
public class CustomOkHttpClientUtil {

    private static Logger logger = LoggerFactory.getLogger(CustomOkHttpClientUtil.class);
    ...
    public static Semaphore getSemaphoreInstance() {
        //只能0个线程同时访问
        synchronized (CustomOkHttpClientUtil.class) {
            if (semaphore == null) {
...
//            sc.init(null,new TrustManager[]{x509TrustManager}, new SecureRandom());
    ...
    public static String getCurrentClassName() {
        return CustomOkHttpClientUtil.class.getName();
    }
